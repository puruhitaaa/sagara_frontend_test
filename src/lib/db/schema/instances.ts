...
export const insertInstanceSchema = createInsertSchema(instances).omit(timestamps);
...
export type CompleteInstance = Awaited<ReturnType<typeof getInstances>>["instances"][number];
